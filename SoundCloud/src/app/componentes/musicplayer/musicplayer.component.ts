...
import { IonFooter, IonToolbar, IonTitle, IonAvatar, IonImg, IonButton, IonRange, IonLabel, IonGrid, IonRow, IonCol, IonIcon } from '@ionic/angular/standalone';
...
@Component({
  ...
  standalone: true,
  imports: [
    IonFooter, IonToolbar, IonTitle, IonAvatar, IonImg, IonButton, IonRange, IonLabel, IonGrid, IonRow, IonCol, NgIf, IonIcon
  ]
})
